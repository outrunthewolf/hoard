    ...
    Collapse.DEFAULTS = {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(startEvent), !startEvent.isDefaultPrevented()) {
                ...
                var complete = function(e) {
                    return e && e.target != this.$element[0] ? void this.$element.one($.support.transition.end, $.proxy(complete, this)) : (this.$element.removeClass("collapsing").addClass("collapse in")[dimension](""), 
                    this.transitioning = 0, void this.$element.trigger("shown.bs.collapse"));
                };
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(startEvent), !startEvent.isDefaultPrevented()) {
                ...
                var complete = function(e) {
                    return e && e.target != this.$element[0] ? void this.$element.one($.support.transition.end, $.proxy(complete, this)) : (this.transitioning = 0, 
                    void this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse"));
                };
